...
@SuppressWarnings("unchecked")
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        image_view.setZoomOffset(new Point(-50, 50));
        image_view.addPropertyChangeListener(new PropertyChangeListener() {
        ...
        fld_f_zoom_border_color.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                onAction(evt);
            }
        });
        ...
        btn_f_zoom_border_color.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                onAction(evt);
            }
        });
        ...
        fld_s_zoom_border_color.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                onAction(evt);
            }
        });
        ...
        btn_s_zoom_border_color.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                onAction(evt);
            }
        });
...
private Color bgNormal = new JTextField().getBackground();
private Color bgError  = new Color(255, 200, 200);
